<nav class="navbar navbar-expand-md fixed-top navbar-dark bg-primary shadow-lg p-3 mb-5">
    ...
    <div class="navbar-collapse offcanvas-collapse bg-primary" id="navbarsExampleDefault">
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item {{ Request::is('employee/dashboard/performance') ? 'active' : ''}}">
                <a href="{{ route('employee.performance') }}" class="nav-link">Evaluation</a>
            </li>
        </ul>
                                    ...
                                    <div class="notification-item">
                                        <div class="media">
                                            <div class="media-left">
                                                <img src="{{ asset('storage/images/') }}/{{ auth()->user()->manager->profile->avatar }}" class="media-object rounded" style="width:60px">
                                            </div>
                                            <div class="media-body" style="padding-left: 5px;">
                                                <p class="media-heading"> 
                                                    {{ auth()->user()->manager->firstname }}
                                                    {{ auth()->user()->manager->lastname }} <br>
                                                    Evaluation 
