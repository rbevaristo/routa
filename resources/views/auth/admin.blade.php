...
<section id="login">
    <div class="container d-flex justify-content-center h-100 align-items-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header text-center bg-primary text-white"><strong>Login as <span class="text-danger">Administrator</span></strong></div>
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-danger btn-round btn-md">
                                    {{ __('Login') }}
                                </button>
                        ...
                        <div class="form-group row text-center">
                            ...
                            <div class="col-md-6">
                                <a class="btn btn-primary text-white" href="{{ route('auth.manager') }}">
                                    {{ __('Login as Manager') }}
                                </a>
                            </div>
                        </div>
