...
<section id="login">
    <div class="container d-flex justify-content-center h-100 align-items-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header text-center bg-primary text-white"><strong>Login as <span class="text-primary">Manager</span></strong></div>
                <div class="card-body">
                    <form method="POST" action="{{ route('login.manager') }}" aria-label="{{ __('Login') }}">
                        @csrf
                        ...
                        <div class="form-group row text-center">
                            ...
                            <div class="col-md-6">
                                <a class="btn btn-danger text-white" href="{{ route('auth.admin') }}">
