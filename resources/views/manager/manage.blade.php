                    ...
                    <div class="card-header bg-primary text-white">
                        ...
                        <span class="float-right dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                ...
                                <a class="dropdown-item" href="{{ route('manager.settings') }}"><i class="fa fa-gear"></i> Scheduler Settings</a>                                
                            </div>
                        </span>
                    </div>
                        ...
                        <table class="table text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            ...
                                            @foreach(\App\Position::all()->where('user_id', null) as $position)
                                                @if($employee->position->name != $position->name && $position->name != 'Manager')
                                    ...
                                    <td>
                                        <input type="checkbox" data-toggle="toggle" id="status" value="{{ $employee->id }}" {{ $employee->active == false ? '' : 'checked' }}>
                                    </td>
                                    <td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form action="{{ route('manager.employee.create') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <div class="input-group">
...
<script>
    $(document).ready(function(){
        ...
        $('input[type="checkbox"]').on('change', function() {
            if ($(this).is(':checked')){ 
                var url = "{{ url('manager/dashboard/manage/status/update') }}";
                $.ajax({
                    url: url,
                    type: 'POST',
                    data: {
        ...
        $('.myposition').on('change', function() {
            var url = "{{ url('manager/dashboard/employee/position/update') }}";
        ...
        $('#activate-all').on('click', function(){
            var url = "{{ url('manager/dashboard/employee/update/all') }}";
            var id = "{{ auth()->user()->id }}";
            $.ajax({
                url: url,
                type: 'POST',
        ...
        $('button.reset').on('click', function(){
            ...
            var url = "{{ url('manager/dashboard/password/reset') }}";
            $.ajax({
                url: url,
                type: 'POST',
                data: {
